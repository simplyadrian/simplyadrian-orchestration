...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "nativex-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/nativex"
  #   chef.validation_client_name = "nativex-validator"
  #   chef.validation_key_path = ".chef/nativex-validator.pem"
  # end
end
