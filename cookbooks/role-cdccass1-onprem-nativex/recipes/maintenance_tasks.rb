...
cron "Cassandra Repair" do
  action node['role-cdccass1-onprem-nativex']['cron_repair_enabled'] ? :create : :delete
  minute '0'
  hour '0'
  day '*'
  month '*'
...
cron "Cassandra ActivityTracking CF Drop" do
  action node['role-cdccass1-onprem-nativex']['cron_activitytracking_drop_enabled'] ? :create : :delete
  minute '0'
  hour '9'
  day '*'
  month '*'
...
cron "Cassandra ActivityTracking Remove Files" do
  action node['role-cdccass1-onprem-nativex']['cron_activitytracking_file_cleanup_enabled'] ? :create : :delete
  minute '30'
  hour '9'
  day '*'
  month '*'
...
cron "Cassandra Take Snapshot" do
  action node['role-cdccass1-onprem-nativex']['cron_take_snapshot_enabled'] ? :create : :delete
  minute '45'
  hour '9'
  day '*'
  month '*'
...
cron "Cassandra Clear Snapshot" do
  action node['role-cdccass1-onprem-nativex']['cron_clear_snapshot_enabled'] ? :create : :delete
  minute '15'
  hour '9'
  day '*'
  month '*'
...
cron "Cassandra Remove Backup Folders" do
  action node['role-cdccass1-onprem-nativex']['cron_remove_backups_enabled'] ? :create : :delete
  minute '45'
  hour '9'
  day '*'
  month '*'
...
cron "Cassandra Remove CommVault Incremental Folders" do
  action node['role-cdccass1-onprem-nativex']['cron_remove_cvincrem_enabled'] ? :create : :delete
  minute '15'
  hour '9'
  day '*'
  month '*'
...
cron "Cassandra Remove CommVault Full Folders" do
  action node['role-cdccass1-onprem-nativex']['cron_remove_cvfull_enabled'] ? :create : :delete
  minute '45'
  hour '9'
  day '*'
  month '*'
...
cron "Cassandra Move Backups for CommVault" do
  action node['role-cdccass1-onprem-nativex']['cron_move_cvbackups_enabled'] ? :create : :delete
  minute '45'
  hour '9'
  day '*'
  month '*'
