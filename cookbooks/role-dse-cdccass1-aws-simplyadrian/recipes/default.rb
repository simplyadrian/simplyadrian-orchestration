#
# Cookbook Name:: role-dse-cdccass1-aws-simplyadrian
# Recipe:: default
#
...
# General info
# Override 'role-dse-simplyadrian' (which itself overrides role-base-simplyadrian)
...
node.default['dse-simplyadrian']['cron_activitytracking_drop_enabled']        = false # until this is the primary cluster
node.default['dse-simplyadrian']['cron_activitytracking_file_cleanup_enabled'] = true
node.default['dse-simplyadrian']['cron_cluster_repair_enabled']               = true
node.default['dse-simplyadrian']['cron_take_snapshot_enabled']                = false # until this is primary cluster & have backup strategy
node.default['dse-simplyadrian']['cron_clear_snapshot_enabled']               = false # until this is primary cluster & have backup strategy

include_recipe "role-dse-simplyadrian"
include_recipe "dse-simplyadrian::maintenance_tasks"
