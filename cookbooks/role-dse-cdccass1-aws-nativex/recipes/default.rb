...
node.default['cassandra']['hinted_handoff_throttle_in_kb']               = 30720
node.default['cassandra']['max_hints_delivery_threads']                  = 2
...
node.default['cassandra']['incremental_backups']                         = true
...
node.default['cassandra']['concurrent_compactors']                       = 10
node.default['cassandra']['multithreaded_compaction']                    = false
node.default['cassandra']['compaction_throughput_mb_per_sec']            = 128
node.default['cassandra']['compaction_preheat_key_cache']                = true
node.default['cassandra']['stream_throughput_outbound_megabits_per_sec'] = nil
node.default['cassandra']['inter_dc_stream_throughput_outbound_Mbps']    = 3072
