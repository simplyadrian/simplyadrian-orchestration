#
# Cookbook Name:: role-iis-webserver-simplyadrian
# Recipe:: default
#
...
node.default['iis-simplyadrian']['features'] = ["IIS-HttpLogging","IIS-CustomLogging","IIS-LoggingLibraries","IIS-ODBCLogging","IIS-RequestMonitor","IIS-HttpTracing",
...
node.default['iis-simplyadrian']['enabled_pools'] = [{:pool_name => 'api.w3i.com',
													:runtime_version => '4.0',
													:pipeline_mode => :Integrated,
													:pool_username => "#{creds['api']['app_pool_username']}",
													:pool_password => "#{creds['api']['app_pool_password']}"}]

node.default['iis-simplyadrian']['enabled_sites'] = [{:site_name => 'external.api.w3i.com',
													:protocol => :http,
													:port => 80,
...
node.default['iis-simplyadrian']['arr_application'] = [{:package_name => 'webFarm',
													:source => webFarm,
													:installer_type => :msi},
...
node.default['iis-simplyadrian']['services'] = [{:service_name =>'W3SVC'},{:service_name =>'WMSVC'}]
node.default['iis-simplyadrian']['arr_helper']['schema_dir'] = 'C:\\Windows\\System32\\inetsrv\\config\\'
node.default['iis-simplyadrian']['arr_helper']['x_forwarded_for_header_name'] = 'simplyadrian-clientip'
node.default['iis-simplyadrian']['arr_helper']['ssl_header_name'] = 'X-ARR-SSL'
node.default['iis-simplyadrian']['arr_helper']['client_header_name'] = 'X-ARR-ClientCert'
node.default['iis-simplyadrian']['arr_helper']['log_guid_name'] = 'X-ARR-LOG-ID'
node.default['ad-simplyadrian']['organizational_unit_level_5'] = 'Web Servers'
include_recipe 'role-win-base-simplyadrian'
include_recipe 'iis-simplyadrian'
include_recipe 'iis-simplyadrian::install-arr-features'
include_recipe 'iis-simplyadrian::install-arr-helper'